...
return view.extend({
    ...
    render: function (data) {
        ...
        m = new form.Map('mihomo', _('PureMihomo'), `${_('Transparent Proxy with Mihomo on OpenWrt.')} <a href="https://github.com/morytyann/OpenWrt-mihomo/wiki" target="_blank">${_('How To Use')}</a>`);
